...
// ── In-memory store (no DB required for MVP prototype) ──────────────────────
// Structure: { groupId: { name, members: [], expenses: [] } }
const store = {};
...
function simplifyDebts(members, expenses) {
  ...
  // Greedy algorithm: minimize number of transfers
...
// DELETE /groups/:id/expenses/:expenseId — Delete an expense (soft-style)
